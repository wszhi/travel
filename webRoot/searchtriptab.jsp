...
<center>
 ...
 <br>
 <table border="1" class="table table-condensed" style="background: rgba(205, 201, 201, 0.3) !important;filter: alpha(opacity=30)">
 	<tr>
 		<td>申请人工号</td><td colspan="5"><%=employee.getEmployee_id()%></td>
 	</tr>
	<tr>
		<td>部门</td>
		<td colspan="5"><%=department.getDepartment_name()%></td>
	</tr>
  	<tr>
  	<td>出差地点</td>
   ...
   <input type="button" onclick="back()" class="btn btn-primary" style="width:220px;height:40px;color:white;" value="返回">
   <br/>
   <br/>
