...
public class SearchTimeFinanceAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(null!=finance_reimburseServiceInterface.getFinance_reimburses(start_time, end_time)){
			finance_reimburses = finance_reimburseServiceInterface.getFinance_reimburses(start_time, end_time);
